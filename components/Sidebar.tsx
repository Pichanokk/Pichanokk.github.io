...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={changeTheme}
        className="w-8/12 px-5 py-2 my-4 text-white bg-black rounded-full cursor-pointer bg-gradient-to-r from-purple-300 to-blue-300 focus:outline-none hover:scale-105 "
      >
        Change Theme
      </button>
    </>
