export const home = {
    domain: 'Pichanokk.github.io',
    name: 'Pichanok ',
    surname: 'Kongsompree',
    subtitle: 'Saraburi Witthayakhom School',
    email: 'pichanokk.247@gmail.com',
    resumeLink:
...
export const about = {
    ...
    hobbies: ['Reading', 'Chess', 'Hiking', 'Swimming'],
    skills: [
        'python',
        'c',
        'css3',
